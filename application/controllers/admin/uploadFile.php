 ...
 */
    ...
    public function index() {
        if(isset($_POST))
        {
            ...
            //$DestinationDirectory   = '/var/www/html/thesavingcoupon/assets/img/coupon/';
            $DestinationDirectory   = '/home/coupon/public_html/beta/assets/img/coupon/';
            $Quality                = 90; //jpeg quality
            ##########################################
            if (strrpos($_SERVER['HTTP_REFERER'], 'publicidad') > -1){
                $BigImageMaxSize = 200;
            }
            if (strrpos($_SERVER['HTTP_REFERER'], 'banner') > -1){
                $BigImageMaxSize = 900;
            }
            if (strrpos($_SERVER['HTTP_REFERER'], 'comercios') > -1){
                $BigImageMaxSize = 600;
            }
